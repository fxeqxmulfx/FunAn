...
\lstdefinelanguage{Lean}{
  morekeywords={theorem,lemma,def,example,import,open,variable,noncomputable,section,namespace,end,where,by,have,let,set,calc,show,exact,apply,intro,rfl,simp,rw,ring,linarith,nlinarith,norm_num,positivity,omega,decide,fun,if,then,else,match,with,instance,class,structure,inductive,private,protected,abbrev},
  sensitive=true,
  morecomment=[l]{--},
  morecomment=[s]{/-}{-/},
  morestring=[b]",
  literate={→}{$\to$}1 {←}{$\leftarrow$}1 {≤}{$\leq$}1 {≥}{$\geq$}1 {≠}{$\neq$}1 {∀}{$\forall$}1 {∃}{$\exists$}1 {∈}{$\in$}1 {⊆}{$\subseteq$}1 {⊂}{$\subset$}1 {∪}{$\cup$}1 {∩}{$\cap$}1 {⊥}{$\bot$}1 {⊤}{$\top$}1 {ℝ}{$\mathbb{R}$}1 {ℂ}{$\mathbb{C}$}1 {ℕ}{$\mathbb{N}$}1 {ℤ}{$\mathbb{Z}$}1 {ℚ}{$\mathbb{Q}$}1 {α}{$\alpha$}1 {β}{$\beta$}1 {γ}{$\gamma$}1 {δ}{$\delta$}1 {ε}{$\varepsilon$}1 {μ}{$\mu$}1 {σ}{$\sigma$}1 {τ}{$\tau$}1 {π}{$\pi$}1 {λ}{$\lambda$}1 {κ}{$\kappa$}1 {∞}{$\infty$}1 {⟨}{$\langle$}1 {⟩}{$\rangle$}1 {‖}{$\|$}1 {·}{$\cdot$}1,
}
...
\vfill
\noindent \copyright \ Башмаков Р.А., Галимов И.С. 2007
...
\lstinputlisting[language=Lean]{FunAn/Section01_SetAlgebra/Task05.lean}

\item Докажите, что прямое произведение полуколец является полукольцом.

\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section01_SetAlgebra/Task06.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section01_SetAlgebra/Task08.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section01_SetAlgebra/Task10.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section01_SetAlgebra/Task11.lean}

\item Докажите, что канторово множество имеет мощность континуума.

\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section01_SetAlgebra/Task12.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section02_Measure/Task01.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section02_Measure/Task02.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section02_Measure/Task03.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section02_Measure/Task04.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section02_Measure/Task11.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section02_Measure/Task13.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section02_Measure/Task14.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section02_Measure/Task18.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section03_MeasurableFunctions/Task01.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section03_MeasurableFunctions/Task02.lean}
\lstinputlisting[language=Lean]{FunAn/Section03_MeasurableFunctions/Task02a.lean}
\lstinputlisting[language=Lean]{FunAn/Section03_MeasurableFunctions/Task02d.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section03_MeasurableFunctions/Task04.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section03_MeasurableFunctions/Task05.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section03_MeasurableFunctions/Task06.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section03_MeasurableFunctions/Task07.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section03_MeasurableFunctions/Task08.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section03_MeasurableFunctions/Task09.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section04_LebesgueIntegral/Task02.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section04_LebesgueIntegral/Task03.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section04_LebesgueIntegral/Task04.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section04_LebesgueIntegral/Task05.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section05_BVandRS/Task01.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section05_BVandRS/Task05.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section05_BVandRS/Task07.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section05_BVandRS/Task09.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section05_BVandRS/Task10.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section05_BVandRS/Task11.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section06_TopologicalSpaces/Task02.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section06_TopologicalSpaces/Task03.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section07_MetricSpaces/Task04.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section07_MetricSpaces/Task05.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section07_MetricSpaces/Task06.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section07_MetricSpaces/Task07.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section08_CompleteMetric/Task01.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section08_CompleteMetric/Task02.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section08_CompleteMetric/Task03.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section08_CompleteMetric/Task04.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section08_CompleteMetric/Task06.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section09_Separable/Task01.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section09_Separable/Task02.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section09_Separable/Task03.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section09_Separable/Task04.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section09_Separable/Task05.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section09_Separable/Task06.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section09_Separable/Task07.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section09_Separable/Task08.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section09_Separable/Task09.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section09_Separable/Task10.lean}

\item Доказать несепарабельность пространства $l_{\infty}$ (см. задачу 2e).

\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section09_Separable/Task11.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section10_Contraction/Task02.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section10_Contraction/Task03.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section10_Contraction/Task04.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section10_Contraction/Task06.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section10_Contraction/Task07.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section10_Contraction/Task08.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section11_NormedSpaces/Task01.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section11_NormedSpaces/Task03.lean}

\item Доказать, что $l^{p}\subset l^{q}$ при $p<q$.

\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section11_NormedSpaces/Task04.lean}

\item Доказать, что $L^{p}(a,b)\supset L^{q}(a,b)$ при $p<q$.

\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section11_NormedSpaces/Task05.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section11_NormedSpaces/Task07.lean}

\item Доказать, что $C[a,b]$ с нормой $||x||=\int_{a}^{b}|x(t)| \, dt$ не полно.

\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section11_NormedSpaces/Task08.lean}

\item Показать, что нормы $\max(||x_{1}||,||x_{2}||)$, $||x_{1}||+||x_{2}||$, $\sqrt{||x_{1}||^{2}+||x_{2}||^{2}}$ эквивалентны на $E\times E$, где $|| \cdot ||$ — норма в $E$.

\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section11_NormedSpaces/Task09.lean}

\item Доказать, что конечномерное подпространство нормированного пространства всегда замкнуто.

\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section11_NormedSpaces/Task10.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section11_NormedSpaces/Task11.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section11_NormedSpaces/Task12.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section11_NormedSpaces/Task13.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section11_NormedSpaces/Task15.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section11_NormedSpaces/Task16.lean}

\item Доказать, что замкнутый единичный шар пространства $l^{1}$ — замкнутое множество пространства $l^{2}$.

\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section11_NormedSpaces/Task17.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section12_HilbertSpaces/Task01.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section12_HilbertSpaces/Task02.lean}

\item Доказать, что пространства $l^{p}$ и $L^{p}(a,b)$ являются гильбертовыми тогда и только тогда, когда $p=2$.

\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section12_HilbertSpaces/Task03.lean}

\item Доказать, что пространство $C[0,\pi]$ не является гильбертовым.

\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section12_HilbertSpaces/Task04.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section12_HilbertSpaces/Task05.lean}

\item Доказать, что для любого $\mathcal{M}\subset H$ множество $\mathcal{M}^{\perp}$ является замкнутым подпространством.

\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section12_HilbertSpaces/Task06.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section12_HilbertSpaces/Task07.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section12_HilbertSpaces/Task08.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section12_HilbertSpaces/Task09.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section12_HilbertSpaces/Task12.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section12_HilbertSpaces/Task13.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section12_HilbertSpaces/Task14.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section12_HilbertSpaces/Task15.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section12_HilbertSpaces/Task17.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section13_LinearFunctionals/Task04.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section14_LinearOperators/Task01.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section14_LinearOperators/Task06.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section14_LinearOperators/Task07.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section15_InverseOperators/Task01.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section15_InverseOperators/Task03.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section15_InverseOperators/Task09.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section15_InverseOperators/Task10.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section15_InverseOperators/Task11.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section17_HahnBanach/Task03.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section17_HahnBanach/Task04.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section17_HahnBanach/Task05.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section17_HahnBanach/Task06.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section17_HahnBanach/Task07.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section17_HahnBanach/Task10.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section18_AdjointOperators/Task04.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section18_AdjointOperators/Task05.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section18_AdjointOperators/Task06.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section19_OperatorConvergence/Task01.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section19_OperatorConvergence/Task02.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section19_OperatorConvergence/Task03.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section19_OperatorConvergence/Task04.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section19_OperatorConvergence/Task06.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section20_CompactSets/Task01.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section20_CompactSets/Task03.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section20_CompactSets/Task05.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section20_CompactSets/Task07.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section20_CompactSets/Task08.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section21_CompactOperators/Task01.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section21_CompactOperators/Task02.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section21_CompactOperators/Task03.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section21_CompactOperators/Task04.lean}
...
\newpage
\begin{center}\small\textbf{Формализация на Lean 4}\end{center}
\lstinputlisting[language=Lean]{FunAn/Section21_CompactOperators/Task09.lean}
